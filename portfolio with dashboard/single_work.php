...
$works = mysqli_query($con, $select);
$after_assoc = mysqli_fetch_assoc($works);

$user_id = $after_assoc['user_id'];

$user_info = "SELECT * FROM students WHERE id=$user_id";
$user_res = mysqli_query($con, $user_info);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img height="500" src="admin/work/upload/<?=$after_assoc['image']?>" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                <a href="https://www.facebook.com/sharer.php?u=http://127.0.0.1/Brim/work_details.php?id="><i class="fab fa-facebook-f"></i></a>
                                                <a href="http://www.twitter.com/share?url=http://127.0.0.1/Brim/work_details.php?id=?>"><i class="fab fa-twitter"></i></a>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img width="50" height="50" src="admin/user/upload/<?=$after_assoc_user['image']?>" alt="img">
                                            </div>
