            ...
            <div class="col-lg-12">
                <!--post-single-image-->
                    <div class="post-single-image">
                        <img src="{{asset('upload/posts/')}}/{{$post['image']}}" style="width:900px;height:600px;" alt="">
                    </div>
                    ...
                    <div class="post-single-body">
                        ...
                        <div class="post-single-title">
                            <h2> {{$post->title}}</h2>
                            <ul class="entry-meta">
                                <li class="post-author-img"><img src="{{asset('upload/posts/')}}/{{$post->rel_to_user['image']}}" alt=""></li>
                                <li class="post-author"> <a href="author.html">{{$post->rel_to_user['name']}}</a></li>
                                <li class="entry-cat"> <a href="blog-layout-1.html" class="category-style-1 "> <span class="line"></span> {{$post->rel_to_cate['category_name']}}</a></li>
                                <li class="post-date"> <span class="line"></span> {{$post->created_at->format('M d,Y')}}</li>
                            </ul>
